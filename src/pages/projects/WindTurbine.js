    ...
    <div class="App" style={{backgroundColor:'#F6F7F8'}}>
      ...
      <div class="page">
        ...
        <div class="body">
          ...
          <p>We performed multiple FEA analysis simulations of Stiffness, Stress and Factor of Safety(FOS). Our Stiffness FEA simulation revealed that the maximum displacemnt of our tower is 0.493 mm which occurred at the top of tower near the rounded section of the motor hub. Wihtin the same general area, the housing faced a moderate amount of deflection and decreased as you go down the tower. <br/> <br/> The image displayed the stress on our tower. The area where the most stress occurs isn't clearly visible but the region of 2.895e+02 PSI is located towards the back of the motor housing. An acceptable amount of stress occurs throughout the tower's pillars mostly in the long upper region that connects to the bottom of the motor housing. <br/><br/> Our last group of FEA simulations was about FOS. The point at which the FOS is highest, 3.62e+04, is in the same area where the most stress occurs. In general our FOS is pretty good because buildings usually use a FOS of around 2 and our minimum FOS is 2.25.</p>
          <div class="imageDivThree">
